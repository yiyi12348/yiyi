...
import static com.cwuom.ouo.HookInit.isDarkMode;
import static com.cwuom.ouo.ui.ResUtils.isInNightMode;
import static com.cwuom.ouo.util.Utils.getHostApp;
...
import com.cwuom.ouo.ui.ResUtils;
...
public class CommonContextWrapper extends ContextThemeWrapper {
    ...
    public static Context createAppCompatContext(@NonNull Context base) {
        ...
        int uiNightMode = Configuration.UI_MODE_NIGHT_YES;
        int currentNightMode = getHostApp().getResources().getConfiguration().uiMode & Configuration.UI_MODE_NIGHT_MASK;
        boolean isDarkMode = currentNightMode == Configuration.UI_MODE_NIGHT_YES;
        if (isDarkMode){
            uiNightMode = Configuration.UI_MODE_NIGHT_NO;
        }
        return new CommonContextWrapper(base, R.style.AppTheme_Ftb,
                recreateNighModeConfig(base, uiNightMode));
    }
